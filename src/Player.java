...
public class Player {
    ...
    public static class Controller implements Runnable {
        ...
        /**
         ...
         Implements the Runnable interface for the Controller class.

         This method creates a new player, waits for the game to start, and logs the player leaving if interrupted.
         @throws RuntimeException if the thread is interrupted before the game starts.
         */
